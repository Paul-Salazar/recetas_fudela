...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_FILES['txtImagen']['error'] == UPLOAD_ERR_OK && !empty($_FILES['txtImagen']['name'])) {
        ...
        $imagen = "../assets/img/categorias/" . $_FILES['txtImagen']['name'];
    ...
    $query = "UPDATE categorias SET nombre = '$nombre', observaciones = '$observaciones', estado = '$estado', imagen = '$imagen'  WHERE id = $id";
    ...
    <div class="col-md-6 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="../includes/editar_categorias.php" method="POST" class="p-1" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <a href="../vistas/crear_categorias.php" class="btn btn-danger">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
